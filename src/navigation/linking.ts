 ...
 * web domain, e.g. kjubilee://dial or https://kjubilee.com/band. Frequency links
 * (…/hm308.70) are handled by useShareDeepLinks, which opens the Dial on that
 * station; React Navigation owns the path-style routes below.
 */
